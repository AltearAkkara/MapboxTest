package com.akkaratanapat.altear.mapboxtest.examples;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(MapboxMap mapboxMap) {
                ...
                final Marker marker = mapboxMap.addMarker(new MarkerViewOptions().position(new LatLng(64.900932, -18.167040)));
